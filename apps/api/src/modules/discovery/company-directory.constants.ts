...
export const TOP_COMPANIES_BY_HUB: TargetCompany[] = [
  // --- BENGALURU UNICORNS & ENTERPRISES ---
  {
    name: 'Swiggy',
    hubId: 'bengaluru',
    ...
    sampleRoles: [
      { title: 'Senior Backend Engineer (Platform)', skills: ['Go', 'Microservices', 'Kafka', 'AWS', 'PostgreSQL'], minExp: 3, workMode: 'HYBRID', minSalary: 3000000, maxSalary: 5500000 },
    ],
  },
  {
    name: 'CRED',
    ...
    sampleRoles: [
      { title: 'Full Stack Engineer (Payments)', skills: ['React', 'Node.js', 'TypeScript', 'Redis', 'AWS'], minExp: 2, workMode: 'ONSITE', minSalary: 2800000, maxSalary: 5000000 },
    ],
  },
  {
    name: 'Razorpay',
    ...
    sampleRoles: [
      { title: 'AI / ML Engineer', skills: ['Python', 'PyTorch', 'LLM', 'FastAPI', 'Docker'], minExp: 2, workMode: 'HYBRID', minSalary: 2600000, maxSalary: 4800000 },
    ],
  },
  {
    name: 'Flipkart',
    ...
    sampleRoles: [
      { title: 'Software Development Engineer II', skills: ['Java', 'Spring Boot', 'Kafka', 'HBase', 'Microservices'], minExp: 3, workMode: 'HYBRID', minSalary: 2800000, maxSalary: 5200000 },
    ],
  },
  // --- BENGALURU ---
  {
